...
import com.example.demo1409.controller.DemoController;
...
public class DemoControllerTest {
    ...
    public void testReverseTextWithSpaces() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/reverse").param("text", "hello world"))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public void testDisemvowelText() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/disemvowel").param("text", "hello"))
                .andExpect(MockMvcResultMatchers.status().isOk())
